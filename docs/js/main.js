  ...
  const workflowDetails = {
    ...
    "zh-TW": {
      1: {
        title: "任务规划",
        content: `
          <p>任务规划阶段是初始阶段，AI助手定义项目范围、设定目标，并建立成功标准。</p>
          <h4 class="text-lg font-semibold mt-4 mb-2">主要活动：</h4>
          <ul class="list-disc pl-6 space-y-2">
            <li>厘清项目需求和约束条件</li>
            <li>设定明确目标和定义可衡量的成功标准</li>
...
function initMultiLanguage() {
  ...
  if (typeof i18n !== "undefined") {
    ...
    console.warn("i18n.js 尚未载入，无法启用完整多语系功能");
    // 尝试提供基本的多语系支持
    try {
...
/**
 * 根据当前语言更新工作流程模态窗口内容
 * @param {string} lang - 当前语言代码 ("en" 或 "zh-TW")
 */
